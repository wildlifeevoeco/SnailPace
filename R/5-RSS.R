...
p3.wide.1hr <- setDT(merge(p3.wide.1hr, Params.exp, by = 'snail', all.x = T))
...
speed.mean <- speed.all[brick != 'g1' & brick != 'g3' & bdist %like% 20.3, .(snail, bdist, bd.spd.before, bd.spd.after, disturbance)]
